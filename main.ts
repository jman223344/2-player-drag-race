mp.onButtonEvent(mp.MultiplayerButton.A, ControllerButtonEvent.Pressed, function (player2) {
    if (Start == 1) {
        mp.getPlayerSprite(player2).vx += 1
    }
})
...
mp.onControllerEvent(ControllerEvent.Connected, function (player2) {
    if (mp.isConnected(mp.playerSelector(mp.PlayerNumber.Two))) {
        ...
        game.splash("Waiting for Players...")
    }
})
let Start = 0
Start = 0
...
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two), sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player))
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).setPosition(10, 30)
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).setPosition(10, 80)
mp.setPlayerIndicatorsVisible(true)
Start = 0
game.onUpdateInterval(500, function () {
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).vx > 0) {
        mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).vx += -1
    } else {
    ...
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).vx > 0) {
        mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).vx += -1
    } else {
        mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).vx = 0
    }
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).x > 150) {
        mp.gameOverPlayerWin(mp.playerSelector(mp.PlayerNumber.One))
    }
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).x > 150) {
